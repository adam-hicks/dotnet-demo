...
6. Please submit your completed test as a zip file, private dropbox or other file sharing link, 
...
.NET Core
------------------------------------------------------------------------------------------
.NET core runs on Windows, Linux and a Mac.
Get setup: https://www.microsoft.com/net/core
For more info: https://docs.microsoft.com/en-us/dotnet/core/get-started

Build and run this application from a terminal:
